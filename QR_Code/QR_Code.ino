...
#define XM 39   // must be an analog pin, use "An" notation!
#define YM 40   // can be a digital pin, this is A0
#define XP 41   // can be a digital pin, this is A3 
...
unsigned int TypeInfomationBits[15] = {
